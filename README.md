...
Using the example of IntelliJ IDE, select **JDK (Java) version 17**. Select the main class: `pl.marcinm312.springbootspotify.SpringBootSpotifyTrackSearchApplication` and set the environment variables as described above.
